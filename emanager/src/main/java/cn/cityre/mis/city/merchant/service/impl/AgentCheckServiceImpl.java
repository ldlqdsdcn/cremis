...
import cn.cityre.mis.center.merchant.dao.CenterUserListDao;
import cn.cityre.mis.city.merchant.dao.CoUserCheckDao;
...
import cn.cityre.mis.city.merchant.service.AgentCheckService;
...
public class AgentCheckServiceImpl implements AgentCheckService {
    ...
    @Autowired
    private CenterUserListDao centerUserListDao;
    ...
    public UserList userinfo(String uid, String citypinyin, String citycode){
        ...
        if(u != null){
            if(StringUtils.isNotEmpty(u.getHeadportrait())){
                ...
                Date regtime = centerUserListDao.selectRegtimeFromCenterDb(uid);
