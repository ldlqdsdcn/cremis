...
<div  class="container-fluid" ng-controller="listTabTrlCtrl">
    <div class="page-header" >
        <a ui-sref="editTabTrl({tabTrlId:null})" ui-sref-active="active" class="btn btn-primary btn-sm"><eidea:label key="common.button.create"/> </a>
        ...
        <div class="span12">
            <table  class="table table-hover table-striped table-condensed">
                ...
                <tr>
                    ...
                    <th><%--tabId--%><eidea:label key="base.tabTrl.label.tabId"/></th>
                    <th><%--lang--%><eidea:label key="base.tabTrl.label.lang"/></th>
                    <th><%--名称--%><eidea:label key="base.tabTrl.label.name"/></th>
                    <th><%--description--%><eidea:label key="base.tabTrl.label.description"/></th>
                    <th><%--帮助--%><eidea:label key="base.tabTrl.label.help"/></th>
                ...
                <tr ng-repeat="model in modelList track by $index" ng-class-even="success">
                    ...
                    <td>
                        <a ui-sref="editTabTrl({tabTrlId:model.id})" ui-sref-active="active" class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"/>&nbsp;<eidea:label key="common.button.edit"/> </a>
                    </td>
                </tr>
                </tbody>
            </table>
