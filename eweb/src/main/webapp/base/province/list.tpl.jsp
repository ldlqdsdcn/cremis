...
<div  class="container-fluid" ng-controller="listCtrl">
    <div class="page-header" >
        <ol class="breadcrumb">
            <li><a href="javascript:;"><i class="icon icon-tasks"></i><eidea:label key="province.title"/></a></li>
        </ol>
        ...
        <div class="span12">
            <table  class="table table-hover table-striped table-condensed">
                ...
                <tr>
                    ...
                    <th><%--provinceid--%><eidea:label key="base.province.label.provinceid"/></th>
                    <th><%--province--%><eidea:label key="base.province.label.province"/></th>
                    <th><%--是否有效--%><eidea:label key="base.province.label.isactive"/></th>
