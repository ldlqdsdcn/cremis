...
<div  class="container-fluid" ng-controller="listCtrl">
    <div class="page-header" >
        <ol class="breadcrumb">
            <li><a href="javascript:;"><i class="icon icon-tasks"></i><eidea:label key="city.title"/></a></li>
        </ol>
        ...
        <div class="span12">
            <table  class="table table-hover table-striped table-condensed">
                ...
                <tr>
                    ...
                    <th><%--cityid--%><eidea:label key="base.city.label.cityid"/></th>
                    <th><%--city--%><eidea:label key="base.city.label.city"/></th>
                    <th><%--provinceid--%><eidea:label key="base.city.label.provinceid"/></th>
                    <th><%--是否有效--%><eidea:label key="base.city.label.isactive"/></th>
