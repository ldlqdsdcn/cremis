        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="productCode" type="text" ng-model="productPo.productCode"
                           placeholder="<eidea:message key="common.please.input">
                    <eidea:param value="base.product.label.productCode" type="label"/></eidea:message> " required/>
                </div>
                <div class="form-group">
                    <label for="productName"><%--productName--%><eidea:label
                            key="base.product.label.productName"/></label>
                    <input class="form-control" id="productName" type="text" ng-model="productPo.productName"
                           placeholder="<eidea:message key="common.please.input">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="platform" type="text" ng-model="productPo.platform"
                           placeholder="<eidea:message key="common.please.input">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="createTime" type="text" ng-model="productPo.createTime"
                           placeholder="<eidea:message key="common.please.input">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="updateTime" type="text" ng-model="productPo.updateTime"
                           placeholder="<eidea:message key="common.please.input">
