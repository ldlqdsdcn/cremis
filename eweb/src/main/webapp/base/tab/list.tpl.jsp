...
<div  class="container-fluid" ng-controller="listTabCtrl">
    <div class="page-header" >
        <a ui-sref="editTab({tabId:null})" ui-sref-active="active" class="btn btn-primary btn-sm" ng-show="canAdd"><eidea:label key="common.button.create"/> </a>
        ...
        <div class="span12">
            <table  class="table table-hover table-striped table-condensed">
                ...
                <tr ng-repeat="model in modelList track by $index" ng-class-even="success">
                    ...
                    <td>
                        <a ui-sref="editTab({tabId:model.id})" ui-sref-active="active" class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"/>&nbsp;<eidea:label key="common.button.edit"/> </a>
                    </td>
                </tr>
                </tbody>
            </table>
