...
<div  class="container-fluid" ng-controller="listCheckboxCtrl">
    <%--<jsp:include page="/common/common_list_button.jsp"/>--%>
    <div class="row-fluid">
        <div class="page-header">
            <a ui-sref="checkboxEdit({checkboxId:null})" ui-sref-active="active" class="btn btn-primary btn-sm"><%--新建--%>
        ...
        <div class="span12">
            <table  class="table table-hover table-striped table-condensed">
                ...
                <tr>
                    ...
                    <th><%--checkedValue--%><eidea:label key="base.elementCheckbox.label.checkedvalue"/></th>
                    <th><%--uncheckedValue--%><eidea:label key="base.elementCheckbox.label.uncheckedvalue"/></th>
                ...
                <tr ng-repeat="model in modelList track by $index" ng-class-even="success">
                    ...
                    <td>
                        {{model.uncheckedValue}}
                    </td>
                    <td>
                            <a ui-sref="checkboxEdit({checkboxId:model.id})" ui-sref-active="active" class="btn btn-primary btn-xs">
