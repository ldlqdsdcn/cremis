...
<div  class="container-fluid" ng-controller="listFieldTrlCtrl">
    <div class="page-header" >
        <a ui-sref="editFieldTrl({fieldTrlId:null})"  ui-sref-active="active" class="btn btn-primary btn-sm"><eidea:label key="common.button.create"/> </a>
        ...
        <div class="span12">
            <table  class="table table-hover table-striped table-condensed">
                ...
                <tr ng-repeat="model in modelList track by $index" ng-class-even="success">
                    ...
                    <td>
                        <a ui-sref="editFieldTrl({fieldTrlId:model.id})"  ui-sref-active="active" class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;<eidea:label key="common.button.edit"/> </a>
                    </td>
                </tr>
                </tbody>
            </table>
