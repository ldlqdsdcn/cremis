...
<div  class="container-fluid" ng-controller="listWindowTrlCtrl">
    <div class="page-header" >
        <a ui-sref="windowTrlEdit({windowTrlId:null})" ui-sref-active="active" class="btn btn-primary btn-sm" ng-show="canAdd"><eidea:label key="common.button.create"/> </a>
        ...
        <div class="span12">
            <table  class="table table-hover table-striped table-condensed">
                ...
                <tr>
                    ...
                    <th><%--windowId--%><eidea:label key="base.windowTrl.label.windowId"/></th>
                    <th><%--lang--%><eidea:label key="base.windowTrl.label.lang"/></th>
                    <th><%--名称--%><eidea:label key="base.windowTrl.label.name"/></th>
                    <th><%--description--%><eidea:label key="base.windowTrl.label.description"/></th>
                    <th><%--帮助--%><eidea:label key="base.windowTrl.label.help"/></th>
                ...
                <tr ng-repeat="model in modelList track by $index" ng-class-even="success">
                    ...
                    <td>
                        <a ui-sref="windowTrlEdit({windowTrlId:model.id})" ui-sref-active="active" class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"/>&nbsp;<eidea:label key="common.button.edit"/> </a>
                    </td>
                </tr>
                </tbody>
            </table>
