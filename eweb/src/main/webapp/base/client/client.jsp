...
<script type="text/javascript">
    ...
    app.controller('listCtrl', function ($rootScope,$scope,$http,$window) {
        ...
        $scope.pageChanged = function () {
            $http.post("<c:url value="/base/client/list"/>", $scope.queryParams)
            ...
            bootbox.confirm({
                ...
                buttons: {
                    ...
                    if (result) {
                        ...
                        $http.post("<c:url value="/base/client/deletes"/>", param).success(function (data) {
                            if (data.success) {
        ...
        $http.get(url)
                .success(function (response) {
                    if (response.success) {
                        ...
                        $scope.tableId=$scope.clientBo.id;
