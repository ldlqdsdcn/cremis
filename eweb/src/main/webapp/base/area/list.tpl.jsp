        ...
        <div class="span12">
            <table  class="table table-hover table-striped table-condensed">
                ...
                <tr>
                    ...
                    <th><%--areaid--%><eidea:label key="base.area.label.areaid"/></th>
                    <th><%--area--%><eidea:label key="base.area.label.area"/></th>
                    <th><%--cityid--%><eidea:label key="base.area.label.cityid"/></th>
                    <th><%--是否有效--%><eidea:label key="base.area.label.isactive"/></th>
