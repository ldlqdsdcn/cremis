...
<div class="container-fluid" ng-controller="listCtrl">
    <div class="page-header">
        <ol class="breadcrumb">
            <li><a href="javascript:;"><i class="icon icon-tasks"></i><eidea:label key="base.phonePin.title"/></a></li>
        </ol>
        ...
        <div class="span12">
            <table class="table table-hover table-striped table-condensed">
                ...
                <tr>
                    ...
                    <th><%--pinCode--%><eidea:label key="base.v2017.phonepin.label.pinCode"/></th>
