    ...
    <form role="form" name="editForm" novalidate ng-submit="addInvoice()"
        ...
        <div class="form-group">
            <p class="text-right">
                ...
                <button type="submit" class="btn btn-default btn-sm">添加开票</button>
            </p>
        </div>
        <div class="form-group">
