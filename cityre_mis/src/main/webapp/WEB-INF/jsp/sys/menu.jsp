    ...
    <div data-options="region:'north',border:false" style="height:70px;overflow:hidden;background:#fafafa;">
        <div class="easyui-panel activityListClass" style="overflow:hidden;font-size:12px;height:65px"
            ...
            <fieldset class="fieldset" style="height: 45px;">
                ...
                &nbsp;&nbsp;&nbsp;<a href="#" id="seach_user" onclick="menuHelper.search()" class="easyui-linkbutton" data-options="iconCls:'icon-search'">查询</a>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <a href="javascript:void(0)"  onclick="menuHelper.add()" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true"  style="margin-left:10px;margin-top:0px">添加</a>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <a href="javascript:void(0)"  onclick="menuHelper.remove()" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true"  style="margin-left:10px;margin-top:0px">删除</a>
            </fieldset>
        </div>
    </div>
    ...
    <div id="menu_dig" class="easyui-window" style="width: 400px;"
        ...
        <form id="modelForm" class="easyui-form" method="post" data-options="novalidate:true">
            <fieldset class="fieldset" >
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td ><input  class="easyui-combobox" id="repositoryId" data-options="url: '<%=path%>/sys/menu/repositories',method: 'get',valueField: 'id',textField: 'name',required:true"/></td>
                    </tr>
                    <tr>
                        <td ><label>父菜单：</label></td>
                        <td ><input  class="easyui-combobox" id="parentMenuId" data-options="url: '<%=path%>/sys/menu/menuFolders',method: 'get',valueField: 'id',textField: 'name',required:true"/></td>
                    </tr>
                    <tr>
            ...
            <div id="dlg-buttons" style="text-align: right">
                <a id="addUser_btn" href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-save',plain:true" onclick="menuHelper.save();">保存</a>
                <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-cancel',plain:true" onclick="menuHelper.closeEditDialog();">取消</a>
            </div>
        </form>
    </div>
</div>
