...
<div id="userPanel" class="easyui-panel" style="width:100%;max-width:100%;padding:30px 60px;">
    <form id="modelForm" class="easyui-form" method="post" data-options="novalidate:true">
        <table width="100%;" border="0">
            ...
            <tr>
                <td>性别: 男<input type="radio" id="nan" name="sex" value="1" checked/> 女<input type="radio" id="nv"
                                                                                             name="sex" value="0">
                    未知<input type="radio" id="unknown" name="sex" value="-1"></td>
                <td>
    ...
    <div style="text-align:center;padding:5px 0">
        <shiro:hasPermission name="account:edit">
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="accountHelper.save()"
               style="width:80px">保存</a>
        </shiro:hasPermission>
        <a href="javascript:void(0)" class="easyui-linkbutton" onclick="  accountHelper.goList();"
    ...
    <table>
        <thead>
        <th><input type="checkbox" onclick="eideaValidator.selectAll('privileges',this)"></th>
        <th>编号</th>
        <th>名称</th>
        </thead>
